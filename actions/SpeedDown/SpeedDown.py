...
class SpeedDown(ActionBase):
    ...
    def on_key_down(self) -> None:
        try:
            result = self.plugin_base.backend.decrease_speed(0.5)
    ...
    def _set_speed_label_from_result(self, payload: dict) -> None:
        ...
        self.set_media(media_path=os.path.join(self.plugin_base.PATH, "assets", "down.svg"), size=0.75)
